        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Story = table.Column<float>(type: "real", nullable: false),
                    Acting = table.Column<float>(type: "real", nullable: false),
                    Music = table.Column<float>(type: "real", nullable: false),
                    RewatchValue = table.Column<float>(type: "real", nullable: false),
